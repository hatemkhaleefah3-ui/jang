...
const staticFiles = ["styles.css", "app-v2.js", "lecture-template.js", "_headers"];
...
console.log(`Prepared ${staticFiles.length + 2} static files in dist/ with adaptive large-file support.`);

...
const staticFiles = ["styles.css", "app-v2.js", "extractor-v2.js", "source-importer.js", "pptx-exporter.js", "lecture-template.js", "_headers"];
...
console.log(`Prepared ${staticFiles.length + 1} static files in dist/ with direct PPTX import and export.`);
